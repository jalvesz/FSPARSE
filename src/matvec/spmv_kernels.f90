...
module spmv_kernels
    ...
    interface spmv_coo
        ...
        module procedure spmv_coo_1d_c
        module procedure spmv_coo_1d_z
        module procedure spmv_coo_2d_c
        module procedure spmv_coo_2d_z
    end interface
    ...
    interface spmv_coo_sym
        ...
        module procedure spmv_coo_sym_1d_c
        module procedure spmv_coo_sym_1d_z
        module procedure spmv_coo_sym_2d_c
        module procedure spmv_coo_sym_2d_z
    end interface
    ...
    interface spmv_csr
        ...
        module procedure spmv_csr_1d_c
        module procedure spmv_csr_1d_z
        module procedure spmv_csr_2d_c
        module procedure spmv_csr_2d_z
    end interface

    interface spmv_csr_syminf
        module procedure spmv_csr_syminf_1d_sp
        module procedure spmv_csr_syminf_1d_dp
        module procedure spmv_csr_syminf_1d_c
        module procedure spmv_csr_syminf_1d_z
    end interface

    interface spmv_csr_symsup
        module procedure spmv_csr_symsup_1d_sp
        module procedure spmv_csr_symsup_1d_dp
        module procedure spmv_csr_symsup_1d_c
        module procedure spmv_csr_symsup_1d_z
    end interface
    ...
    interface spmv_csc
        ...
        module procedure spmv_csc_1d_c
        module procedure spmv_csc_1d_z
        module procedure spmv_csc_2d_c
        module procedure spmv_csc_2d_z
    end interface
    ...
    interface spmv_ell
        ...
        module procedure spmv_ell_1d_c
        module procedure spmv_ell_1d_z
        module procedure spmv_ell_2d_c
        module procedure spmv_ell_2d_z
    end interface
    ...
    subroutine spmv_coo_1d_c(data,index,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_coo_c_1d.inc'
    end subroutine

    subroutine spmv_coo_1d_z(data,index,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_coo_c_1d.inc'
    end subroutine

    subroutine spmv_coo_2d_c(data,index,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_coo_c_2d.inc'
    end subroutine

    subroutine spmv_coo_2d_z(data,index,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_coo_c_2d.inc'
    end subroutine
    ...
    subroutine spmv_coo_sym_1d_c(data,index,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_coo_sym_c_1d.inc'
    end subroutine

    subroutine spmv_coo_sym_1d_z(data,index,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_coo_sym_c_1d.inc'
    end subroutine

    subroutine spmv_coo_sym_2d_c(data,index,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_coo_sym_c_2d.inc'
    end subroutine

    subroutine spmv_coo_sym_2d_z(data,index,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_coo_sym_c_2d.inc'
    end subroutine
    ...
    subroutine spmv_csr_1d_c(data,col,rowptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_csr_c_1d.inc'
    end subroutine

    subroutine spmv_csr_1d_z(data,col,rowptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_csr_c_1d.inc'
    end subroutine

    subroutine spmv_csr_2d_c(data,col,rowptr,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_csr_c_2d.inc'
    end subroutine

    subroutine spmv_csr_2d_z(data,col,rowptr,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_csr_c_2d.inc'
    end subroutine
    ...
    subroutine spmv_csr_syminf_1d_c(data,col,rowptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_csr_syminf_c_1d.inc'
    end subroutine

    subroutine spmv_csr_syminf_1d_z(data,col,rowptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_csr_syminf_c_1d.inc'
    end subroutine
    ...
    subroutine spmv_csr_symsup_1d_c(data,col,rowptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_csr_symsup_c_1d.inc'
    end subroutine

    subroutine spmv_csr_symsup_1d_z(data,col,rowptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_csr_symsup_c_1d.inc'
    end subroutine
    ...
    subroutine spmv_csc_1d_c(data,row,colptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_csc_c_1d.inc'
    end subroutine

    subroutine spmv_csc_1d_z(data,row,colptr,nrows,ncols,NNZ,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_csc_c_1d.inc'
    end subroutine

    subroutine spmv_csc_2d_c(data,row,colptr,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_csc_c_2d.inc'
    end subroutine

    subroutine spmv_csc_2d_z(data,row,colptr,nrows,ncols,NNZ,dim,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_csc_c_2d.inc'
    end subroutine
    ...
    subroutine spmv_ell_1d_c(data,index,nrows,ncols,MNZ_P_ROW,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_ell_c_1d.inc'
    end subroutine

    subroutine spmv_ell_1d_z(data,index,nrows,ncols,MNZ_P_ROW,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_ell_c_1d.inc'
    end subroutine

    subroutine spmv_ell_2d_c(data,index,nrows,ncols,MNZ_P_ROW,dim,vec_x,vec_y)
        integer, parameter      :: wp = 4
        include 'spmv_ell_c_2d.inc'
    end subroutine

    subroutine spmv_ell_2d_z(data,index,nrows,ncols,MNZ_P_ROW,dim,vec_x,vec_y)
        integer, parameter      :: wp = 8
        include 'spmv_ell_c_2d.inc'
    end subroutine
