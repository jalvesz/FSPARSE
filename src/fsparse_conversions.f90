...
contains
    ...
    subroutine coo2dense_qp(COO,dense)
        integer, parameter :: wp = qp
        type(COO_qp), intent(in) :: COO
        real(qp), intent(inout) :: dense(:,:)
        integer :: idx
    ...
    subroutine coo2dense_cqp(COO,dense)
        integer, parameter :: wp = qp
        type(COO_cqp), intent(in) :: COO
        complex(qp), intent(inout) :: dense(:,:)
        integer :: idx
    ...
    subroutine coo2csr_ordered_qp(COO,CSR)
        !! coo2csr_ordered: This function enables transfering data from a COO matrix to a CSR matrix
        !! under the hypothesis that the COO is already ordered.
        type(COO_qp), intent(in)    :: COO
        type(CSR_qp), intent(inout) :: CSR
        integer :: i
    ...
    subroutine coo2csr_ordered_cqp(COO,CSR)
        !! coo2csr_ordered: This function enables transfering data from a COO matrix to a CSR matrix
        !! under the hypothesis that the COO is already ordered.
        type(COO_cqp), intent(in)    :: COO
        type(CSR_cqp), intent(inout) :: CSR
        integer :: i
